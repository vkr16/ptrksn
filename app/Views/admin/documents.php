                    ...
                    <div class="col-md-12 d-flex justify-content-between align-items-center p-3 my-2">
                        ...
                        <nav aria-label="breadcrumb" class="m-0">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?= HOST_URL ?>/admin/projects/detail?id=<?= $_GET['p']; ?>">Acara</a></li>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= HOST_URL ?>/admin/projects/events/delete?filename=<?= $file['file_name']; ?>&e=<?= $event[0]['id']; ?>&p=<?= $_GET['p']; ?>" class=" btn btn-sm btn-danger"><i class="fa-solid fa-trash-can"></i> Hapus</a>
